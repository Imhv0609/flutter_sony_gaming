...
#ifndef GAME_CONTROLLER_SWIFT_H
#define GAME_CONTROLLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="game_controller",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15game_controller11AppDelegate")
...
SWIFT_CLASS("_TtC15game_controller17MainFlutterWindow")
